...
import jottrImg from '../assets/projects/Jottr/image.webp'
import libraflowImg from '../assets/projects/Libraflow/image.webp'
import streamixImg from '../assets/projects/Streamix/image.webp'
import gittoolImg from '../assets/projects/Gittool/image.webp'
...
/** One sticky card scene — occupies its own 100vh scroll lane */
function ProjectCard({ project, index, count, containerProgress }) {
  // Each card "owns" a 1/count slice of the container scroll.
  // We map our slice progress to a scale. Once the next card
  // starts fully overlapping (progress > our slice end), we scale to targetScale.
  ...
  const CARD_TOP = 90 // px below viewport top where cards stick
      ...
      >
        ...
        >
          ...
          <div style={{
            ...
            {/* Subtle accent glow behind the mockup */}
            <div style={{
              position: 'absolute',
              top: '-30%', right: '-10%',
              width: '60%', height: '60%',
            ...
            {/* Screenshot — fills all remaining height */}
            <div style={{ flex: 1, overflow: 'hidden', position: 'relative', lineHeight: 0 }}>
              ...
              />
              {/* Subtle bottom gradient so it fades into the card bottom */}
              <div style={{
                position: 'absolute',
...
export default function Projects() {
  ...
  // Track scroll progress of the whole projects container
  ...
  return (
    <section id="work" style={{ position: 'relative' }}>
      {/* Pinned header that disappears as you scroll into the stack */}
      ...
      {/* The scroll container — breaks out of container, goes full viewport width */}
      <div
        ref={containerRef}
        style={{
