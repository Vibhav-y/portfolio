...
export const FEATURED_PROJECTS = [
  {
    ...
    brief:
      'A collaborative knowledge workspace built around CRDTs, so several people can edit the same document without conflicts, locks, or stale snapshots. The editor holds local state in Yjs and applies edits optimistically, reconciling with peers as they reconnect — including anyone who has been working offline.',
    description:
  ...
  },
  {
    ...
    brief:
      'A desktop client that wraps the messy parts of Git in a visual interface — branch graphs, inline and side-by-side diffs, stash management, and interactive rebase. One Electron and TypeScript codebase ships natively to macOS, Windows, and Linux, with libgit2 handling repository operations underneath.',
    description:
  ...
  },
  {
    ...
    brief:
      'An AI-native customer platform where a campaign starts as one sentence. Describe the outcome and it finds the audience, picks the channel, drafts the message, and returns a complete proposal — nothing sends without your approval, and every rupee of revenue traces back to its source.',
    description:
